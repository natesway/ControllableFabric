...
public class RenderEvents
{
    ...
    public void onClientTick(TickEvent.ClientTickEvent event)
    {
        ...
        if(event.phase == TickEvent.Phase.START && mc.player != null && !mc.options.hideGui)
        {
            ...
            EventTaxi.executeEventTaxi(new GatherActionsEvent(actionMap, visibility));
    ...
    {
        if(!/*EventTaxi.executeEventTaxi(new RenderAvailableActionsEvent())*/false)
        {
            Minecraft mc = Minecraft.getInstance();
...
*/
    ...
    private void renderMiniPlayer()
    {
        ...
        {
            if(!/*MinecraftForge.EVENT_BUS.post(new RenderPlayerPreviewEvent())*/false)
            {
